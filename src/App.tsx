  ...
  return (
    <div className="min-h-screen bg-[#fffdfa] text-slate-900 font-sans selection:bg-indigo-100 relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/60 backdrop-blur-xl">
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-8 lg:px-12 h-24 flex items-center justify-between">
      ...
      <main className="w-full max-w-[1280px] mx-auto px-4 md:px-8 lg:px-12 py-8 md:py-16">
      ...
      <footer className="py-16 border-t bg-white relative overflow-hidden">
        ...
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-8 lg:px-12 text-center space-y-8 relative z-10">
